...
#
# Counter-Strike: Source Installer
#

container_run_and_extract(
    name = "install_cstrike",
    extract_file = "/cstrike.tar",
    commands = [
...
install_pkgs(
    name = "server_deps_image",
    image_tar = "@server_base//image",
    installables_tar = ":server_deps.tar",
    installation_cleanup_commands = "rm -rf /var/lib/apt/lists/*",
    output_image_name = "server_deps_image",
)
...
container_image(
    ...
    compression = "gzip",
    base = "server_deps_image.tar",
    tars = [
        ":install_cstrike/cstrike.tar",
    ],
)
